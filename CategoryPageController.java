...
public class CategoryPageController extends AbstractHPECategoryPageController
{
	...
	final String categoryCode, // NOSONAR
			...
			final String searchQuery, @RequestParam(value = "textSearch", required = false)
			final String textSearch, @RequestParam(value = "page", defaultValue = "0")
